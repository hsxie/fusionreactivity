...
for j=1:length(TT)
    ...
    tmp2=cputime;
    [sgmv2,stdsgmv2]=fsgmvmcdrm(vt1x,vt1z,vd1x,vd1y,vd1z,vd1r,vt2x,vt2z,vd2x,vd2y,vd2z,vd2r,N2,1);
    tmp2=cputime-tmp2; runtime2=runtime2+tmp2;
    tmp3=cputime;
    [sgmv3,stdsgmv3]=fsgmvmcdrm(vt1x,vt1z,vd1x,vd1y,vd1z,vd1r,vt2x,vt2z,vd2x,vd2y,vd2z,vd2r,N3,1);
...
print(gcf,'-dpng',['smgv_mc_cmp_drm_Rt=',num2str(Rt),'_Ed=',num2str(EdkeV),'_N1=',num2str(N),...
